...
import auctionArtwork from "@/assets/shop/auction-dominic-tshabangu-behind-table-mountain.png";
          ...
          {split ? (
            <>
              <div className={SPLIT_IMAGE_CELL}>
                <img
                  src={auctionArtwork}
                  alt={`${featuredAuction.title} — silent auction`}
                  className={`${SPLIT_IMG_COVER} object-contain bg-white`}
                />
              </div>
              <div className={splitTextPaneClass("")}>
                ...
                {featuredAuction.closesAt ? (
                  <p className="text-xs text-neutral-500 max-w-lg shrink-0">
                    Auction closes {featuredAuction.closesAt}
                  </p>
                ) : null}
              </div>
            </>
            ...
            <div className={rowCompact}>
              ...
              >
                ...
                {featuredAuction.closesAt ? (
                  <p className="text-xs text-neutral-500 mt-3">Auction closes {featuredAuction.closesAt}</p>
                ) : null}
              </div>
            </div>
          )}
