...
Generic platform boilerplate (`· Episode`, Instagram login text, etc.) is **rejected**. The batch menu also **replaces** existing generic descriptions (manual text is never overwritten).
