...
Body includes date/time, customer contact details, delivery area, a readable order table (wine, qty, price, line total), total bottles, estimated total (when prices are configured), and notes. **Reply-To** is the customer’s email.
